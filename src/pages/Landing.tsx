    ...
    <div className="flex flex-col min-h-screen bg-background overflow-x-hidden">
      ...
      >
        ...
        >
          <Link
            to="/pricing"
            className="text-sm font-medium animated-underline hover:text-primary transition-colors duration-300"
          >
            Pricing
          </Link>
          ...
          <StaggerContainer className="max-w-4xl mx-auto">
            ...
            <StaggerItem>
              <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-8">
                Achiverr helps you turn your dreams into actionable plans with
                AI-powered roadmaps and daily tasks tailored to your goals.
              </p>
            </StaggerItem>
            ...
            <StaggerItem>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button
                  asChild
                  size="lg"
                  className="gap-2 group bg-accent hover:bg-accent/90 btn-hover"
                >
                  <Link to="/dashboard">
                    Get Started
                    <motion.div
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <div className="glow">
                  ...
                  <p className="text-muted-foreground text-sm">
                    See your goals evolve in real-time
                  </p>
                </div>
                ...
                <div className="glow">
                  ...
                  <p className="text-muted-foreground text-sm">
                    Daily actions toward your success
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4">
          <FadeIn className="text-center mb-16">
            ...
            <p className="text-muted-foreground mt-4 max-w-2xl mx-auto">
              Achiverr's AI-powered platform breaks down your goals into
              achievable steps
            </p>
          </FadeIn>
          ...
          >
            <StaggerItem>
              <HoverCard className="enhanced-card p-8 h-full">
                ...
                <p className="text-muted-foreground">
                  Define clear objectives with customizable timeframes that fit
            ...
            <StaggerItem>
              <HoverCard className="enhanced-card p-8 h-full">
                ...
                <p className="text-muted-foreground">
                  Get personalized action plans generated by advanced AI to
                  guide your journey
                </p>
              </HoverCard>
            </StaggerItem>
            ...
            <StaggerItem>
              <HoverCard className="enhanced-card p-8 h-full">
                ...
                <p className="text-muted-foreground">
                  Track progress with adaptive daily task lists that adjust to
                  your pace
                </p>
              </HoverCard>
            </StaggerItem>
          ...
          <FadeIn delay={0.3} className="mt-24">
            <div className="grid md:grid-cols-2 gap-12 items-center max-w-5xl mx-auto">
              <div>
                <div className="glass rounded-2xl overflow-hidden"></div>
              </div>
              <div className="space-y-6">
                <h3 className="text-2xl font-bold">Visualize Your Journey</h3>
                <p className="text-muted-foreground">
                  Our interactive roadmaps give you a clear view of your
                  progress and what's ahead. Each milestone represents a key
                  step toward achieving your goal.
                </p>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            >
              <Link
                to="/pricing"
                className="animated-underline hover:text-foreground transition-colors duration-300"
              >
                Pricing
              </Link>
              <a
